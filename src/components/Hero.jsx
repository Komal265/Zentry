  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        text-5xl sm:text-7xl md:text-9xl lg:text-[12rem] sm:right-10"
        >
          G<b>a</b>ming
        </h1>
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            <h1
              className="special-font hero-heading top-5 left-5  text-blue-100
        text-5xl sm:text-7xl md:text-9xl lg:text-[12rem] sm:right-10"
            >
              Redefi<b>n</b>e
            </h1>
            ...
            <Button
              ...
              containerClass="!bg-yellow-300 flex items-center gap-1 transition-transform duration-300 hover:scale-110"
              onClick={() =>
                window.open(
